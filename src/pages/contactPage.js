...
class ContactPage extends Component {
    ...
    sendMessage(event) {
        ...
        emailjs
          .send("gmail", "james_personal_portfolio", templateParams,`${EmailJSID}`)
          .then(
            function(response) {
...
render() {
  return (
    <main id="main-contact">
        ...
        <p id="contact-page-text">Currently finishing coding program!</p>

        <div className="icons">

        <a href="https://github.com/jameslee70" rel="noopener noreferrer" target="_blank">
        <img src={github} className="icon-github" alt="Github Icon" /></a>
       
        <a href="https://www.linkedin.com/in/james-lee-327a071b1/" rel="noopener noreferrer" target="_blank">
